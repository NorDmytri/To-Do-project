            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    if (user.EmailConfirmed == true)
                    {
                        ...
                        // Создаю сессию (хранит Id)
                        Session["UserId"] = user.Id.ToString();
                        // а также куки (хранит id)
                        HttpContext.Response.Cookies["CookUserId"].Value = user.Id;
                ...
                {
                    ModelState.AddModelError("", Resources.Resource.WrongLogPass);
                }
